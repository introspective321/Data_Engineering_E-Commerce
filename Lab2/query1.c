...
void get_artists_with_artwork_2023() {
    MYSQL *conn;
    MYSQL_RES *res;
    MYSQL_ROW row;
    ...
    char *query = "SELECT DISTINCT a.artist_name, aw.title "
                  "FROM Artist a "
    ...
    printf("Artists with artwork listings in all months of 2023:\n");
